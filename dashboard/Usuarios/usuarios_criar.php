            ...
            <section>
                <div class="form-group">
                    ...
                    <form action="validar_cadastro.php" method="POST">
                        ...
                        <label class="ml-4 mt-3 label-senha-adn">Senha do administrador</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-4 col-md-4 col-lg-4">
                                <input type="button" value="Sair" class="btn btn-primary botao mb-4" onclick="window.location.href='../Principal/principal.php'" >
                            </div>
                        </div>
                    </form>
                </div>
